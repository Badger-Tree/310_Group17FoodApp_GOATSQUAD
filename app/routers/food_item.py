...
def get_all_food(restaurant_id: int = None, course: str = None):
    """GET all food items, with optional filtering by restaurant_id and course. Returns list of food items that match criteria. If no filters, returns all food items."""
