...
from app.services.order_service import CartItemResponse, CartResponse, DeliveryResponse
import pytest
...
def mock_load_addresses():
    ...
    "created_date": "2025-02-20T12:34:56"
}]
...
@pytest.fixture
def mock_load_all_carts():
    return [{
    "customer_id": "573a4392-a818-4e6e-8887-d24b4c443ca1",
    "cart_id": "01KMF44FJHDA79MKCBEMKY2XW9",
    "cart_items": [
        {
            "cart_item_id": "01KMF6YQ7CKMJCDS8XDWCSDJNJ",
            "food_item_id": 1,
            "quantity": 1,
            "price_per_item": 15.5,
            "subtotal": 15.5
...
@pytest.fixture
def mock_save_all_carts(*args, **kwargs):
    return None
...
def load_users():
    [{
        ...
        "password": "string",
        "role": "CUSTOMER",
        "created_date": "2026-03-24T05:12:31.056005+00:00"
    },{
        "id": 2,
...
def mock_delivery_response():
    return [{
        ...
        "user_id": "1",
        "role": "CUSTOMER",
        "created": "2026-03-24T17:37:07.684736+00:00",
        "expires": "2026-03-24T18:37:07.684736+00:00"
    },
    {
        "token": "token2",
        "user_id": "2",
...
def test_create_order_success():
    """"""
    patch("app.services.order_service.load_orders", return_value = mock_load_orders)
    patch("app.services.order_service.load_order_items", return_value = mock_load_order_items)
    patch("app.services.order_service.save_all_orders", return_value = mock_save_orders)
    patch("app.services.order_service.save_all_order_items", return_value = mock_save_all_order_items)
...
#                                             response = client.post("/orders/create_order/1/4",headers={"token":"123"})
...
#     response = client.post("/orders/create_order/1/4")
